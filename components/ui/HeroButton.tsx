const HeroButton = ({ name }: { name: string }) => {
  return (
    <button className="group relative dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden">
      ...
      >
        <span
          className="block z-20 h-full w-12 blur-xl -translate-x-1/2 rounded-full"
          style={{
            animation:
      ...
      <span className="flex items-center justify-center gap-1 relative z-[20] dark:bg-neutral-950/90 bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full">
